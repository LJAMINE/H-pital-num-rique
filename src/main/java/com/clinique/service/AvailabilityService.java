...
public class AvailabilityService {
    ...
    public Availability addAvailabity(Long doctorId, DayOfWeek dayOfWeek, LocalTime startTime, LocalTime endTime) {
        ...
        availability.setStartTime(LocalDateTime.from(startTime));
        availability.setEndTime(LocalDateTime.from(endTime));
    ...
    public Availability updateAvailabity(Long availabilityId, DayOfWeek dayOfWeek, LocalTime startTime, LocalTime endTime) {
        ...
        existingAvailability.setStartTime(LocalDateTime.from(startTime));
        existingAvailability.setEndTime(LocalDateTime.from(endTime));
