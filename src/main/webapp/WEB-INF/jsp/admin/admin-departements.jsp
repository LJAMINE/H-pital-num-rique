...
<div class="container">
    ...
    <ul>
        ...
        <li>
            ...
            <a class="delete-link" href="departement?action=delete&idDepartement=<%= dep.getIdDepartement() %>">Delete</a>
        </li>
        <% } %>
    </ul>
